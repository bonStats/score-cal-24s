---
title: "Bayesian score calibration and SBI"
author: "Joshua J Bon"
...
![](imgs/score-cal-paper2.png)

:::

::::

arXiv: [https://doi.org/10.48550/arXiv.2211.05357](https://doi.org/10.48550/arXiv.2211.05357)

Slides: [https://bonstats.github.io/score-cal-24s/](https://bonstats.github.io/score-cal-24s/)
...
"Waiting for Bayes" [Shout-out to Jacinta Holloway-Brown]{style="font-size: 50%;"}
...
## How to score an approximation when we know the truth?
...
$$\Pi(\text{d}\theta ~\vert~\tilde{y} )P(\text{d}\tilde{y}) = P(\text{d}\tilde{y}~\vert~\theta)\Pi(\text{d}\theta )$$
...
BSC settings: $M = 200$ and $\bar\Pi = \hat\Pi(\cdot~\vert~y)$, scaled by 1.5
