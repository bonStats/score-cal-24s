...
## Can we correct posteriors based on approximation(s)? {.center}
...
Two-step Mitogen Activated Protein Kinase enzymatic cascade
...
X^* + P_1 &\overset{k_4}{\rightarrow} [X^{a}P_1], \\
